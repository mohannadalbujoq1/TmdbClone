...
const MenuIcon = styled.div`
  ...
  &:hover {
    filter: brightness(0) saturate(100%) invert(13%) sepia(100%) saturate(7000%) hue-rotate(240deg) brightness(90%) contrast(90%);
  }
`;
  ...
  return (
    <Card key={movie.id} role="article">
      ...
      <CircleProgress>
        ...
        <RatingText>
          {ratingPercent}<PercentSign>%</PercentSign>
        </RatingText>
        <CircleProgressSvg viewBox="0 0 36 36">
          <path
            d="M18 2.0845
              ...
              a 15.9155 15.9155 0 0 1 0 -31.831"
            fill="none"
            stroke={ratingPercent >= 70 ? "green" : ratingPercent >= 40 ? "orange" : "red"}
            strokeWidth="4"
